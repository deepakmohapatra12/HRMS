				<br>
					<div class="row">
                    <div class="white-box">
					 <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal"><i class="ti-pencil-alt"></i> New Salary </button>
					 
					  <a href="<?php echo BASEURL;?>hr/empsalary" class="btn btn-warning btn-sm"> Back </a>
                        <div class="table-responsive">
                            <table class="table product-overview" id="myTable">
							<caption class="text-center"><h4>Salary Process</h4><hr class="m-t-0 m-b-0"></caption>
								...
								{ ?>
                                    <tr>
										...
										<a href="<?php echo BASEURL;?>hr/deletepayslip/<?php echo $this->uri->segment(3);?>/<?php echo $sal->salaryid;?>"> <i class="fa fa-trash fa-lg"></i> </a> 
										</td>
                                    </tr>
                                <?php } ?>    
                                </tbody>
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<i>Total Present Days</i>
					<input type="text" id="presentdays"  class="form-control input-sm" placeholder="Present Days">
				</div>
			...
			<div class="col-sm-6">
				...
				<div class="form-group">
					<i>Total Days In Month</i>
					<input type="text" id="tdays"  class="form-control input-sm" placeholder="Total Month Days">
				</div>
		...
		$(function()
		{
...

			{
				...
				if(status==true)
				{
					var mydata = {"total":total, "pt":ptt,"medical":med,"other":oth,"paid":pd,"basic":bas,"hra":hr,"special":spcl,"net":nets,"empid":$("#empid").val(),"month":$("#month").val(),"year":$("#year").val(),"tdays":$("#tdays").val(),"presentdays":$("#presentdays").val()};
